...
namespace MarketPlaceBackend.Contracts
{
    public interface IApplicationService
    {
        ...
        Task<IEnumerable<Object>> getApplicationsWithoutId();
        Task<IEnumerable<Object>> getAllApplicationsAsUserObjectOfOnboarding();
        ...
        Task<Object> getApplicationIdBasedOnEmail(string email);
    }
}
